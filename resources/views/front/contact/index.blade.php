...
@section('content')
<hr>
<div class="container" style="color: #a30409;">
    <div class="row">
        <div class="d-flex justify-content-between">
            <h6>
                <i class="fa-solid fa-phone"></i> +{{ $siteSettings->phone_number }}
            </h6>
            <h6>
                <i class="fab fa-solid fa-whatsapp"></i> +{{ $siteSettings->whatsapp_number }}
            </h6>
            <h6>
                <i class="fa fa-solid fa-envelope"></i> {{ $siteSettings->email_address }}
            </h6>
        </div>
    </div>
</div>
...
<hr>
    <div class="mycontainer d-flex justify-content-center align-items-center">
                    ...
                    <g id="g16">
                        ...
                        <g id="g54">
                            <path id="path56"
                                ...
                                stroke="#e00a11" stroke-width="2.541" stroke-miterlimit="10" stroke-dasharray="7.62 7.62" />
                        </g>
                        <g id="g58">
                            <path id="path60"
                        ...
                        <g id="g62">
                            <path id="path64" d="M107.952 308.508C121.544 366.877 153.477 420.713 197.968 460.267"
                                stroke="#a30409ff" stroke-width="2.02" stroke-miterlimit="10" />
                        </g>
                        <g id="g66">
                            <path id="path68"
                        ...
                        <g id="g70">
                            <path id="path72" d="M633.861 349.129C617.182 393.899 586.452 433.173 547.233 459.836"
                                stroke="#a30409ff" stroke-width="1.612" stroke-miterlimit="10" />
                        </g>
                        <g id="g74">
                            <path id="path76" d="M198.233 424.458C213.177 349.774 197.247 269.251 155.048 206.17"
                                stroke="#e00a11" stroke-width="2.541" stroke-miterlimit="10" />
                        </g>
                        <g id="g78">
                            <path id="path80"
                        ...
                        <g id="g158">
                            <path id="path160" d="M194.298 545.299C131.158 507.676 73.43 460.749 23.4922 406.451"
                                stroke="#a30409ff" stroke-width="2.541" stroke-miterlimit="10" />
                        </g>
                        <g id="g162">
                            <path id="path164"
                        ...
                        <g id="g166">
                            <path id="path168" d="M558.719 549.691C601.746 514.86 639.767 473.689 671.212 427.878"
                                stroke="#a30409ff" stroke-width="1.91" stroke-miterlimit="10" />
                        </g>
                        <g id="g170">
                            <path id="path172"
        ...
        <form id="contact-form" method="post" action="{{ route('submitContactForm') }}">
            @csrf
            <h1 class="title text-center mb-4">Bize Ulaşın</h1>
            ...
            <div class="form-group position-relative">
                <input type="text" name="subject" id="subject" class="form-control form-control-lg thick"
            ...
            <div class="form-group message">
                <textarea id="formMessage" name="message" class="form-control form-control-lg" rows="7"
                    placeholder="Mesajınız"></textarea required>
                        </div>

                        <!-- Submit btn -->
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary" tabIndex="-1">Gönder</button>
                        </div>
                    </form>
