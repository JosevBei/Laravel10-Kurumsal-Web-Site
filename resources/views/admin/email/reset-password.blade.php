...
<head>
    ...
    <title>Marsia Design - Parolanızı Sıfırlayın</title>
</head>
                        ...
                        <div class="card radius-10 w-100 mt-8">
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h4>Şifreni yenilemek için aşağıdaki bağlantıya tıkla.</h4>
                                </div>
                                <a class="btn btn-primary" href="{{route('passwordResetToken', ['token' => $token])}}">
                                    Yeni Parola
                                </a>
                            </div>
                        </div>
