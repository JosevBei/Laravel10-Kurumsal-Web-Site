        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <h6 class="mb-0 text-uppercase" style="color: #f3a01d;">{{$about->name}} - Düzenle</h6>
                    <hr>
                        ...
                        <div class="card-body">
                            <div class="border p-3 rounded">
                                <form action="{{ route('about.update', $about) }}" method="POST"
                                    ...
                                    @method('PUT')
                                    <div class="mb-3">
                                        <h5 class="text-center" style="color: #874c9e;">{{$about->name}}</h5>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="content" class="form-control"
                                            rows="3">{{ old('content', $about->content) }}</textarea>
                                        @error('content')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
